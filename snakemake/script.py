...
class RustScript(ScriptBase):
    ...
    def generate_preamble(
        ...
        snakemake = dict(
            input=encode_namedlist(input_.plainstrings()._allitems()),
            output=encode_namedlist(output.plainstrings()._allitems()),
            ...
            log=encode_namedlist(log.plainstrings()._allitems()),
