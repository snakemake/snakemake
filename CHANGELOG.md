...
* above feature introduces inability to parse slurm specific time format (e.g. "hh:mm:ss"). Newly allowed human friendly time format (e.g. "1d") adds portability among various job schedulers and clusters ([#2154](https://github.com/snakemake/snakemake/issues/2154))
