...
As a convenience syntax, hosted source files can also be referenced as ``github.com:owner/repo@ref:path/to/Snakefile`` or ``gitlab.example.org:group/project@ref:path/to/Snakefile``.
