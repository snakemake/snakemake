...
From the base snakemake folder you call :code:`pytest` to run all the tests, or select specific tests with the :code:`-k` flag.

.. code-block:: console

   $ pytest
   $ pytest tests/tests.py -k test_log_input
