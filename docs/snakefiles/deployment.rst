...
Both with the github/gitlab markers and with the convenience syntax, Snakemake can cache the used git repository, such that it does not have to be downloaded on each invocation.
