...
Such files need to be marked with the ``group_jobs`` option in both the input and output sections, similar to the :ref:`local <snakefiles-storage-local-files>` flag.
