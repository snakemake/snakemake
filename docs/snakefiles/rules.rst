...
Command-line arguments can also be passed to scripts, they can contain wildcards and params, e.g. ``"scripts/script.py argument1 {params.argument2}"`` (Since Snakemake version XXX). Script filenames can't contain spaces, even if the name is quoted.
