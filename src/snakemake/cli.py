...
def parse_args(argv):
    ...
    if args.workflow_profile != "none":
        ...
        if snakefile is not None and (workflow_profile is None or not workflow_profile.is_file()):
